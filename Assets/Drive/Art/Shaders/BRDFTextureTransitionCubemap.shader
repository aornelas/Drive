...
// ---------------------------------------------------------------------
 ...
 Shader "Magic Leap/BRDF/TextureTransitionCube"
 {
	Properties
	{
		_Color ("Main Color", Color) = (1,1,1,1)
		_MainTex ("Color Map", 2D) = "black" {}
		_TransTex ("Alt Color Map", 2D) = "black" {}
		_Trans ("Transition", Range(0.0,1.0)) = 1.0
	...
	SubShader
	{
		...
		{
			half4 maintex = lerp(tex2D (_MainTex, IN.uv_MainTex),tex2D (_TransTex, IN.uv_MainTex),_Trans);
