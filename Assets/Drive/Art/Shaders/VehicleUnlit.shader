...
Shader "Magic Leap/Vehicle Unlit"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( ( _AmbientColor + ( dotResult19 * _LightColor * _LightStrength ) ) * ( tex2D( _MainTexture, uv_MainTexture ) + ( _ReflectionAmount * texCUBE( _ReflectionMap, ase_worldReflection ) ) ) ) + ( tex2DNode23 * tex2DNode23.a * _EmissionAmount ) ).rgb;
			o.Alpha = _FadeObject;
		}
...
/*ASEBEGIN
Version=15401
0;44;1680;966;763.8392;-497.1462;1.009998;True;True
...
Node;AmplifyShaderEditor.SamplerNode;35;-367.2933,1038.304;Float;True;Property;_ReflectionMap;Reflection Map;3;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;47;-379.6812,754.7115;Float;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Instance;23;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;66.82527,922.0272;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;23;9.716467,1382.253;Float;True;Property;_MainTexture;Main Texture;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F95A60C4DA8F2608F639A2A8714238431F102113