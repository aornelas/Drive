...
// ---------------------------------------------------------------------
 ...
 Shader "Magic Leap/Particles/BRDF Particle"
 {
	Properties
	{
	...
	SubShader
	{
		...
		Lighting Off
		CGPROGRAM
		#pragma surface surf RampLight vertex:vert novertexlights exclude_path:prepass noambient noforwardadd nolightmap nodirlightmap
		#pragma target 3.0
